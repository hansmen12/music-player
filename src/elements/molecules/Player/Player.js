...
export default function Player() {
    ...
    return (
        <div className="w-full fixed bg-primary bottom-0 h-[100px] flex justify-between items-center pr-2 z-10">
            <div className="md:w-[33%] h-full flex items-center">
            ...
            <div className="flex items-center md:w-[33%] mx-2">
                <div>
                    {/* <AiFillFastBackward className="text-white cursor-pointer" size={30}/> */}
                </div>
                <div className="w-14 h-14 p-2 bg-[rgba(255,255,255,0.4)] rounded-full flex items-center justify-center md:mx-5 cursor-pointer" onClick={handlePlay}>
                    {pause ? 
            ...
            <div className="flex ">
                ...
                // /> */}
            { music && 
                <audio id="myAudio" controls autoplay ref={refMusic} className="hidden">
